...
import NewFoto from "./components/NewLeson";
import Cats from "./components/Cats";
import Color from "./components/Color";
import ColorJs from "./components/ColorJs";
import Sum from "./components/Sum";
import SumSum from "./components/SumSum";
...
function App() {
  const [getData, setData] = useState("tai bent");
  ...
  return (
    <div className="App">
      <h1>{getData}</h1>
      <button onClick={logSome}>Click</button>
      ...
      <div className="colors" style={{ backgroundColor: getColor }}>
        {colors.map((x) => (
          <ColorJs color={x} setColor={setColor} />
        ))}
      </div>
